...
import MenuBarContentMac from "./menuBarContentMac/MenuBarContentMac"
...
const MenuBarMac = () => {
  ...
  return (
    <div
      onClick={() => closeMenu}
      className="border-box flex flex-row justify-between w-screen h-6 bg-gray-600  top-24 left-0 bg-opacity-40 border-b border-gray-500 z-10"
    >
...
export default memo(MenuBarMac)
